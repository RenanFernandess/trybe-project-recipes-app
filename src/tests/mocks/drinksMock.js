...
const BAILEYS_CREAM = 'Baileys irish cream';
const COCKTAIL_GLASS = 'Cocktail glass';
const GRAND_MARNIER = 'Grand Marnier';
const COFFEE_OR_TEA = 'Coffee / Tea';
...
const ALL_DRINKS_MOCK = {
  drinks: DRINKS,
};

// https://www.thecocktaildb.com/api/json/v1/1/search.php?s=
export default ALL_DRINKS_MOCK;
...
export const DRINK_CATEGORIES_MOCK = {
  drinks: [
    {
